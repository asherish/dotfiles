...
- [x] Claude Code (settings, hooks, shared agent instructions, external skills)
- [x] Codex (mise install, shared agent instructions, synced MCP config, external skills)
